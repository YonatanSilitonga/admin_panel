        ...
        <main class="main-content">
            <div class="isi">
                ...
                <div class="data">
                        ...
                        <form method="GET" action="{{ route('guru.index') }}"
                            ...
                            <div class="d-flex align-items-center gap-2">
                                ...
                                <select name="status" id="status" class="form-select">
                                    ...
                                    <option value="aktif"
                                        {{ request('status') == 'aktif' || !request()->has('status') ? 'selected' : '' }}>
                                        Aktif</option>
                    ...
                    <!-- Modal View Guru -->
                    <div class="modal fade" id="modalViewGuru" tabindex="-1" aria-labelledby="modalViewGuruLabel"
                        aria-hidden="true">
                    ...
                    <script>
                        $(document).ready(function() {
                                    ...
                                    success: function(response) {
                                        ...
                                        if (response.wali_kelas && response.wali_kelas.length > 0) {
                                            ...
                                            response.wali_kelas.forEach((kelas, index) => {
                                                const statusBadge = kelas.status_tahun_ajaran ===
                                                    'Aktif' ?
                                                    '<span class="badge bg-success ms-1">Aktif</span>' :
                                                    '<span class="badge bg-secondary ms-1">Tidak Aktif</span>';

                                                waliKelasText +=
                                                    `${kelas.nama_kelas} (${kelas.tahun_ajaran}) ${statusBadge}`;
                            ...
                            `;
                                            ...
                                            $('#table-jadwal-body').html(
                                                '<tr><td colspan="5" class="text-center">Tidak ada jadwal mengajar</td></tr>'
                                                );
                                        }
                                    },
                                    error: function(xhr) {
