                ...
                <div class="data">
                                ...
                                <select name="tahun_ajaran" id="tahun_ajaran" class="form-select">
                                    ...
                                    @foreach($tahunAjaranList as $ta)
                                        <option value="{{ $ta->id_tahun_ajaran }}"
                                            style="{{ $ta->aktif ? 'background-color:#d4edda;font-weight:bold' : '' }}"
                                            {{
                    ...
                    @if($kelas->isEmpty())
                        <div class="alert alert-info">
                            <i class="bi bi-info-circle me-2"></i> Tidak ada kelas.
                        </div>
                    @else
                        <!-- Tabel Kelas -->
                        <div class="table-responsive">
                            <table id="kelasTable" class="table table-striped table-bordered table-sm nowrap w-100">
